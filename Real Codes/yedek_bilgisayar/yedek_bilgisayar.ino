...
void loop() {
 ...
 accX = process_acceleration(mpu.ax,scale_2g);
 accY = process_acceleration(mpu.ay,scale_2g);
 accZ = process_acceleration(mpu.az,scale_2g);

 magX = process_angular_velocity(mpu.gx,scale_250dps);
 magY = process_angular_velocity(mpu.gy,scale_250dps);
 magZ = process_angular_velocity(mpu.gz,scale_250dps);
